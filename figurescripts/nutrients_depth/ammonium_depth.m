% script plots ammonium with depth for all discrete bottling samples
%
...
xlim([0 2]);
ylim([0 370]);
xlabel(['\fontsize{24}Ammonium (' char(181) '\fontsize{24}M)']);
...
% finaldir=['/path/'];
% %savename
% savename='PC1608-totalammonium-depth';
% %

% script plots silicate with depth for all discrete bottling samples
%
...
xlim([0 25]);
ylim([0 370]);
xlabel(['\fontsize{24}Silicate (' char(181) '\fontsize{24}M)']);
...
% finaldir=['/path/'];
% %savename
% savename='PC1608-totalsilicate-depth';
% %

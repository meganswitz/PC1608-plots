% script creates a TS diagram with points colored by nitrate concentration
%
...
caxis([0 22.22]);
h = colorbar;
h.Label.String = ['Nitrate (' char(181) 'M)'];
h.Direction = 'reverse';
h.Label.FontSize = 18;
h.FontSize = 14;
h.Ticks = [0, 5.555, 11.11, 16.665, 22.22];
h.YTickLabel={'0.00', '5.56', '11.11', '16.67', '22.22'};

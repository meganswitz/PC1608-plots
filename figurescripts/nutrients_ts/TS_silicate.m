% script creates TS diagram with points colored by phosphate concentration
%
...
caxis([0.31 21.07]);
h = colorbar;
h.Label.String = ['Silicate (' char(181) 'M)'];
h.Direction = 'reverse';
h.Label.FontSize = 18;
h.FontSize = 14;
h.Ticks = [0.31, 5.50, 10.69, 15.88, 21.07];
h.YTickLabel={'0.31', '5.50', '10.69', '15.88', '21.07'};
